# 回溯的概念
回溯知识讲解的总览
![](Pasted%20image%2020250809100744.png)

通过一个案例，说明嵌套循环的局限性
![](Pasted%20image%2020250809100952.png)

联系递归，从原问题和子问题的角度考虑，原问题的解可以通过子问题的解来完成，那么就考虑使用递归算法
![](Pasted%20image%2020250809101443.png)

递归和回溯有什么关系？
![](Pasted%20image%2020250809101514.png)

递归的核心在于边界条件和非边界条件，如果这两个写对了，递归就是正确的，重点放在圈出来的部分
![](Pasted%20image%2020250809101931.png)

dfs(i)表示的是枚举大于等于i的部分，所以其子问题就是dfs(i + 1) ，所以是从dfs(i)递归到dfs(i + 1)
![](Pasted%20image%2020250809102107.png)
...
![](Pasted%20image%2020250812200321.png)
...
### 模板二：答案的视角
![](Pasted%20image%2020250812201123.png)
![](Pasted%20image%2020250812201158.png)
```python
def dfs(i):
	ans.append(path.copy())
	if i == n
...
```
### 例题-分割回文串
![](Pasted%20image%2020250812201810.png)

> 假设每两个字符之间都有一个逗号，对于每一个逗号，考虑选它还是不选它，这样就将问题转换为子集问题


![](Pasted%20image%2020250812201706.png)

> 从答案的视角分析

![](Pasted%20image%2020250812202020.png)
